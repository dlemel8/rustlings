...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        let red = u8::try_from(tuple.0).or_else(|_| Err("red invalid"))?;
        let green = u8::try_from(tuple.1).or_else(|_| Err("green invalid"))?;
        let blue = u8::try_from(tuple.2).or_else(|_| Err("blue invalid"))?;
